...
<body>
    <div class="container-wrapper">
        <div class="login-wrapper flex h-screen">
            ...
            <div class="l-login-wrapper bg-black w-[100%] sm:w-[33%] px-8">
                ...
                <div class="sign-in-f-wrapper  mt-8">
                    <h1 class="text-2xl text-white mb-8 ">Sign In As <span class="text-5xl block font-bold">Teacher</span></h1>
                    <div class="form-wrapper w-full">
                        <form class="max-w-full">
                            ...
                            <div class="mt-3 mb-1 text-white">
                                <span class="italic text-gray-300 text-sm">Are you not a teacher?</span>
                            </div>
                            <div class="w-full">
                                <a href="{{route('student-login')}}"
                                    class="text-white border-blue-700 border hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full px-5 py-2.5 text-center block">Sign In as Student</a>
                            </div>
                        </form>
                    </div>
                </div>
